...
This is just a little git love reference, which we expect to grow over time. It's not all encompassing. Some things, you must explore on your own. This love story assumes you've already been introduced to git and have a github account.
